              ...
              <div style={{ display: "flex", gap: 16, padding: "18px 20px", background: S.navy2, border: "1px solid " + S.border, borderRadius: 12, alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: S.muted, lineHeight: 1.7, marginBottom: 10 }}>
                    Kliknij <strong style={{ color: S.coral }}>Export</strong> przy liczbie wyników na dole strony (np. <em>"489 results"</em>) — ten przycisk eksportuje <strong style={{ color: S.green }}>WSZYSTKIE wyniki</strong> z pełną listą zapytań, wolumenem i danymi o wzmiankowaniu. Ahrefs zapisuje w UTF-16 — narzędzie obsługuje to automatycznie.
                  </div>
